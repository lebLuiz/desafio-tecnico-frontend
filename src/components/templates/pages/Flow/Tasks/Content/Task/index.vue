<template>
  ...
  >
    ...
    <TaskName
      :str-automation-name="props.task.str_automation_name"
      :str-step-name="props.task.str_step_name"
    />
    ...
    <TaskDate
      :ts-created-at="props.task.ts_created_at"
      :str-step-label="props.task.str_step_label"
    />
